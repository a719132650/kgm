        ...
        <div class="k-form">
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="100px" label-position="left">
                ...
                <el-form-item label="dataMode" prop="dataMode">
                    <el-autocomplete
                        class="inline-input"
                        v-model="form.dataMode"
                        :fetch-suggestions="querySearchDataMode"
                    ></el-autocomplete>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        initRangeObj(){
            this.form = {
                oid:this.rangeObj.oid,
                dataMode:this.rangeObj.dataMode,
                rangeId:this.rangeObj.rangeId,
                id:this.rangeObj.id,
                label:this.rangeObj.label,
                description:this.rangeObj.description
            }
        },
        getRangeDataModes(){
            var me = this;
